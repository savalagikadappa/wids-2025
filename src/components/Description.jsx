...
function Description() {
  return (
    <div className="description">
      ...
      <div className="events-updates-container">

        <div className="past-events">
          <h3>Past Events</h3>
          <ul>
            <li><a href="https://drive.google.com/file/d/1mSyf-BHyuCy0Wdy9_H2_UT9se7N10h7Y/view?usp=sharing">WiDS Workshop 2024</a></li>
            {/* <li><a href="https://drive.google.com/file/d/1GMt0NW68iw74bqKBv9ZV7AfTrKNKrDGG/view?usp=sharing">WiDS Workshop 2023</a></li> */}
